...
# parameter format: "operation=xx;value=xx;unit=xx;key=xx;"
#                   "metadata=xx;metadata1=xx;metadata2=xx;metadata3=xx"
# If some fields don't exist, then don't include them into the parameter.
#
# Mandory field: "operation";
# Don't include "value=xx" if "value=1" since this api
# will add a default value "1" to this field;
# Don't include "unit=xx" if "unit=count" since this api
# will add a default value "count" to this field.
log_to_kdm_minerva () {
    local default=""
